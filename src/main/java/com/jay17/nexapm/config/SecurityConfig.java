...
import com.jay17.nexapm.security.JwtAuthenticationFilter;
 ...
 *
 * <p>Política de acceso por rol:
 * <ul>
 *   <li>ADMIN: acceso total a todos los endpoints de gestión.</li>
 *   <li>CONSULTOR: solo puede acceder a sus proyectos asignados, registrar avance y horas.</li>
 * </ul>
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Consultores: sus proyectos + seguimiento + asignaciones propias
